...
const style = {
    ...
    backButton: `text-3xl flex  px-[30px] absolute text-white justify-start justify-between w-full rounded-full`,
    ...
    details: `text-center items-center justify-center px-3`,
         ...
         <div className='flex flex-col'>
           <div className='relative flex flex-col '>
             <div className='flex flex-col items-center'>
               <Image src={BG} quality={100} width={1500} alt='bg' height={450} className='w-full h-[15vh] relative shadow-lg object-cover' />
